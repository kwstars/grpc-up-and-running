...
// Source: github.com/kwstars/grpc-up-and-running/api/product_info/v2 (interfaces: ProductInfoClient)
...
import (
	...
	v2 "github.com/kwstars/grpc-up-and-running/api/product_info/v2"
...
func (m *MockProductInfoClient) AddProduct(arg0 context.Context, arg1 *v2.Product, arg2 ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductInfoClient) GetProduct(arg0 context.Context, arg1 *wrapperspb.StringValue, arg2 ...grpc.CallOption) (*v2.Product, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
